          ...
          {fieldCells.map((cell) => {
            ...
            return (
              <div key={cell.id} className='min-w-0 flex-1 overflow-hidden'>
                ...
                <div className='min-w-0 overflow-hidden text-xs [&_:is([data-slot=badge-cell],[data-slot=provider-badge],[data-slot=status-badge])]:ms-0'>
      ...
      {contentCells.map((cell) => {
        ...
        if (!label) {
          return (
            <div
              key={cell.id}
              className='flex justify-end overflow-hidden [&_:is([data-slot=badge-cell],[data-slot=provider-badge],[data-slot=status-badge])]:ms-0'
            >
              <StatusBadgeTypeContext.Provider value='text'>
                {renderCellContent(cell)}
              </StatusBadgeTypeContext.Provider>
        ...
        return (
          ...
          >
            ...
            <div className='flex min-w-0 flex-1 items-center justify-end overflow-hidden text-xs [&_:is([data-slot=badge-cell],[data-slot=provider-badge],[data-slot=status-badge])]:ms-0'>
              <StatusBadgeTypeContext.Provider value='text'>
                {renderCellContent(cell) ?? '-'}
              </StatusBadgeTypeContext.Provider>
            </div>
