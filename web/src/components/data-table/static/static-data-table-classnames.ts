...
export const staticDataTableClassNames = {
  ...
  compactHeaderCellRight:
    'text-muted-foreground py-2 text-end text-[10px] font-medium tracking-wider uppercase',
  compactCell: 'py-2.5',
  compactTopCell: 'py-2.5 align-top',
  compactTopNumericCell: 'py-2.5 text-end align-top font-mono',
  compactMutedCell: 'text-muted-foreground py-2.5',
  compactMutedCodeCell: 'text-muted-foreground py-2.5 font-mono',
  compactNumericCell: 'py-2.5 text-end font-mono',
  compactMutedNumericCell: 'text-muted-foreground py-2.5 text-end font-mono',
  ...
  topNumericCell: 'py-2 text-end font-mono',
  mediumCell: 'font-medium',
  actionHeaderCell: 'w-auto max-w-none text-end',
  actionCell: 'w-auto max-w-none text-end',
} as const
